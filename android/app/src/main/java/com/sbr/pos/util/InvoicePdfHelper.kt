...
object InvoicePdfHelper {
    ...
    fun generateA4InvoicePdf(context: Context, sale: Sale): File {
        ...
        canvas.drawText("SRI BALAJI RENEWABLES", 30f, 40f, textPaint)

        textPaint.textSize = 10f
        textPaint.typeface = Typeface.DEFAULT
        canvas.drawText("No: 240, Netaji Rd, Tirupati • Phone: +91 98490 99800", 30f, 60f, textPaint)
        ...
        sale.items.forEachIndexed { index, item ->
            ...
            var name = item.displayProductName
        ...
        textPaint.typeface = Typeface.DEFAULT
        val footerText = "Thank you for your business! • Sri Balaji Renewables"
